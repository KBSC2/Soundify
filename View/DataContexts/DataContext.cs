...
namespace View.DataContexts
{
    public class DataContext : INotifyPropertyChanged
    {
        ...
        public string PathToImage => CurrentSong == null ? "../Assets/null.png" : CurrentSong.PathToImage == null ? FileCache.Instance.GetFile("images/noimage.png") : FileCache.Instance.GetFile(CurrentSong.PathToImage);
